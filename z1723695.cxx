 ...
 * 
 * Purpose: Utilize fork, exec, and wait system
 * 			calls to make a simple command 
...
//Begin process to divide inputed string into command and options/arguments	
...
//The options and arguments are separated into their own strings	
		else if (curSect == 1){
...
//Set of if statements to determine how many options and/or arguments have been entered and pass the proper number of arguments to execlp				
		...
		//If no options or arguments were entered by user
		if (curSect == 1){
		...
		//If one option or argument was entered by user
		if (curSect == 2){
		...
		//If two options and/or arguments were entered by user
		if (curSect == 3){
		...
		//If three options and/or arguments were entered by user
		if (curSect == 4){
		...
		//If four options and/or arguments were entered by user
		if (curSect == 5){
